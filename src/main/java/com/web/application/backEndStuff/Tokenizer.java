...
public class Tokenizer {
   public final static String tokenizermodelPATH = new String("/Users/benfaer/IdeaProjects/LitterLogic/src/main/java/com/web/application/backEndStuff/models/tokenizer.bin");
    public final static String tokenizerPTATH = new String("/Users/benfaer/IdeaProjects/LitterLogic/src/main/java/com/web/application/backEndStuff/tokenizer_dataset.txt");
    public static void main(String[] args) throws Exception {
        ...
        InputStreamFactory inputStreamFactory = new MarkableFileInputStreamFactory(new File(tokenizerPTATH));
        ...
        model.serialize(new File(tokenizermodelPATH));
